...
class App extends React.Component {
  ...
  autoLogin = () => {
   ...
   try {
     ...
     if (value !== null) {
       fetch(`https://chewsy-backend-api.herokuapp.com/autologin`, {
         headers: {
  ...
  clickHandler=(state)=>{
    ...
    let username = state.username
      ...
      fetch("https://chewsy-backend-api.herokuapp.com/login", {
        method: "POST",
        headers: {
          "Accept": "application/json",
  ...
  addHandler=(id)=>{
    ...
    fetch("https://chewsy-backend-api.herokuapp.com/favorites/", {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
            "Accept": "application/json"
  ...
  ActionSheetIOS.showActionSheetWithOptions(
    ...
    (buttonIndex) => {
      if (buttonIndex === 1) {
        ...
        fetch(`https://chewsy-backend-api.herokuapp.com/favorites/${favorite.id}`, {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
            "Accept": "application/json"
